...
const ExperienceConfirmation = ({route, navigation}) => {
  ...
  return(
    <View style={{ alignItems: "center", flexDirection: 'column', display: 'flex', width: "100%", height: "100%", backgroundColor: 'white'}}>
        ...
        <Text style={[styles.experienceTitle, {fontSize:20, width: "80%", fontWeight: 20, color: "#E15F41", marginTop: 50}]}>Confirmed! Please check your email for the event details.</Text>
        <View style={[{width: "90%", justifyContent: "center", alignItems:"center", position: 'absolute', top:"65%"}]}>
            <TouchableOpacity
